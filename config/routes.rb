Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      get '/identities/schemes/organisation', to: 'identities_schemes_organisations#organisations'
      ...
      get '/identities/schemes', to: 'identities_schemes_organisations#organisations'
