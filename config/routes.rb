Rails.application.routes.draw do
  ...
  get '/identities/schemes/organisations/:ccs_org_id/all', to: 'api/v1/all_registered_organisations_schemes#search_organisation'
  get '/identities/schemes/organisations/sso/:ccs_org_id/all', to: 'api/v1/utilities/all_registered_organisations_schemes#search_all_organisation'
