...
[
  ...
  {scheme_name: 'National Health Service Organisations Registry', scheme_register_code: 'GB-NHS', scheme_uri: 'https://www.gca.gov.uk', scheme_country_code: 'GB', scheme_identifier: 'NHS Registered Number'},
  {scheme_name: 'Department for Education', scheme_register_code: 'GB-EDU', scheme_uri: 'https://www.gca.gov.uk', scheme_country_code: 'GB', scheme_identifier: 'Registered DfE URN'},
  {scheme_name: 'Government Commercial Agency', scheme_register_code: 'GB-CCS', scheme_uri: 'https://www.gca.gov.uk', scheme_country_code: 'GB', scheme_identifier: 'Government Commercial Agency Internal Number'},
  {scheme_name: 'Public Procurement Organisation Number', scheme_register_code: 'GB-PPG', scheme_uri: 'https://www.gca.gov.uk', scheme_country_code: 'GB', scheme_identifier: 'Government Commercial AgencyPPON Number'}
