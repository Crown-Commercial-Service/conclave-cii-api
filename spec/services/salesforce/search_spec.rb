...
RSpec.describe Salesforce::Search, type: :services do
  ...
  describe 'Search salesforce records' do
    it 'Search Companies house record' do
      ...
      expect(result).to eq({ id: 'NSO7IUSHF98HFP9WEH9FFZ~56734565467', legalName: 'Dummy organisation', scheme: 'GB-CCS', uri: '/services/data/v46.0/subjects/Accout/NSO7IUSHF98HFP9WEH9FFZ' })
    end
