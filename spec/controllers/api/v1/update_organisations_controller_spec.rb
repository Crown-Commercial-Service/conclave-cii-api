  ...
  describe 'index' do
    context 'when authenticated' do
      ...
      context 'when success' do
        ...
        it 'returns 201' do
          put :index, params: { ccs_org_id: ccs_org_id, identifier: { id: organisation_scheme_identifier.ccs_org_id, scheme: scheme_register.scheme_register_code } }
      ...
      context 'when not found' do
        it 'returns 404' do
          put :index, params: { ccs_org_id: 'test', identifier: { id: 'test', scheme: 'test' } }
      ...
      context 'when invalid params' do
        it 'returns 400' do
          put :index, params: { ccs_org_id: nil, identifier: { id: nil, scheme: nil } }
