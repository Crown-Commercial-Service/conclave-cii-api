  ...
  xdescribe 'search_organisation' do
    context 'when authenticated' do
      ...
      context 'when success' do
        ...
        it 'returns 200' do
          post :search_organisation, params: { id: organisation_scheme_identifier.ccs_org_id, scheme: scheme_register.scheme_register_code, ccs_org_id: organisation_scheme_identifier.ccs_org_id }
      ...
      context 'when not found' do
        it 'returns 404' do
          post :search_organisation, params: { id: 'test', scheme: 'test', ccs_org_id: 'test' }
