  ...
  module V1
    class UpdateOrganisationsController < ActionController::API
      ...
      def index
        ...
        Common::SalesforceHelper.new(result, params[:organisation_id]).insert_salesforce_record if result.present?
        ...
        if result.blank?
          ...
          render json: { organisation_id: @organisation_id }, status: :ok
        end
      end
      ...
      def update_organisation(organisation)
        ...
        organisation[:organisation_id] = params[:organisation_id]
        ...
        organisation.save
        @organisation_id = organisation.present? ? params[:organisation_id] : nil
      end
