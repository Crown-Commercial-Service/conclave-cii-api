module Common
  class AdditionalIdentifier
    ...
    def schemes
      [SCHEME_ENG_WALES_CHARITY, SCHEME_NORTHEN_IRELAND_CHARITY, SCHEME_SCOTISH_CHARITY, SCHEME_COMPANIES_HOUSE, SCHEME_DANDB, SCHEME_NHS, SCHEME_DFE, SCHEME_SF_ID, SCHEME_SF_URN]
    end
