...
cf ssh conclave-cii-"$CF_SPACE" -t -c "/tmp/lifecycle/shell /home/vcap/app 'bundle exec wheneverize .;bundle exec whenever --clear-crontab;bundle exec whenever --update-crontab'"
